var lineOptions = {
    ...
    line = new ApexCharts(document.querySelector("#line"), lineOptions),
    candle = new ApexCharts(document.querySelector("#candle"), candleOptions),
    radialGradient = new ApexCharts(document.querySelector("#radialGradient"), radialGradientOptions),
    area = new ApexCharts(document.querySelector("#area"), areaOptions);
area.render(), radialGradient.render(), candle.render(), bar.render(), line.render();